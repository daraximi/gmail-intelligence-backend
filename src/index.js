        ...
        const response = await fetch('https://api.openai.com/v1/responses', {
            ...
            body: JSON.stringify({
                ...
                input: [
                    {
                        role: 'system',
                        content: 'You are a professional communication coach. Give a rewritten version of the provided email to be more professional, clear, and workplace-appropriate while maintaining the original intent.',
                    },
                    {
                        role: 'user',
